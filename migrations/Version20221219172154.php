 ...
 */
final class Version20221219172154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(32) NOT NULL, name VARCHAR(64) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, status VARCHAR(32) DEFAULT NULL, estimate INT DEFAULT NULL, spent INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
